package com.interstellar.elite.core.requestmodel.Rto;
...
public class VehicleRegCertificateRequestEntity implements Parcelable {
    ...
    public static final Creator<VehicleRegCertificateRequestEntity> CREATOR = new Creator<VehicleRegCertificateRequestEntity>() {
        @Override
